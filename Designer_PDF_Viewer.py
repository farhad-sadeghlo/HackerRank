...
#
# Letter heights are a=1, b=3, c=1,  and . The tallest letter, b, is 3mm high. The selection area for this word is:
# 3(1mm)*3mm = 9mm.
#
...
class Designer_PDF_Viewer:
    ...
    def __init__(self, word):
        ...
        self.h = list(map(int, h.rstrip().split()))
        self.word = word

    def designerPdfViewer(self):
        ...
        for letter in self.word:
            ...
            counter += 1
            cur_index = letters.index(letter)

            if self.h[cur_index] > temp:

                temp = self.h[cur_index]

        return print(counter * temp)
